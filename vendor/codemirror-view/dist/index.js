    ...
    updateSelection(mustRead = false, fromPointer = false) {
        ...
        if (force || !domSel.focusNode || (!isEquivalentPosition(anchor.node, anchor.offset, domSel.anchorNode, domSel.anchorOffset) ||
            ...
            this.view.observer.ignore(() => {
                ...
                // With controlled scrolling, an offscreen caret can land in a block
                // gap during redraw. Cycling focus there reopens a dismissed keyboard
                // as scrolling settles. Keep focus entirely under user control in
                // this mode, including after the gesture has ended.
                if (!this.view.state.facet(controlledTouchScroll) &&
                    browser.android && browser.chrome && dom.contains(domSel.focusNode) &&
...
class DOMObserver {
    ...
    onScrollChanged(e) {
        ...
        let nativeScroll = ((_b = this.view.controlledTouchScrollController) === null || _b === void 0 ? void 0 : _b.renderCritical) ||
            isNativeScrollActivity(input.touchActive, input.lastTouchTime, input.lastWheelEvent, now);
    ...
    onResize() {
        var _a;
        (_a = this.view.controlledTouchScrollController) === null || _a === void 0 ? void 0 : _a.onResize();
...
class ControlledTouchScroll {
    constructor(view, supported = browser.android && browser.chrome) {
        ...
        this.onTouchStart = (event) => {
            ...
            let nonEditable = (_a = target === null || target === void 0 ? void 0 : target.closest) === null || _a === void 0 ? void 0 : _a.call(target, "[contenteditable=false]");
            if (!this.enabled || event.defaultPrevented || event.touches.length != 1 ||
                target != this.view.scrollDOM && (!target || !this.view.contentDOM.contains(target) ||
                    ((_b = target.closest) === null || _b === void 0 ? void 0 : _b.call(target, "input, textarea, select, button, a")) ||
            ...
            this.pendingDelta = 0;
            this.direction = 0;
            this.samples = [{ at: ((_c = this.config) === null || _c === void 0 ? void 0 : _c.waitForRendering) ? this.now() : event.timeStamp,
                    top: ((_d = this.config) === null || _d === void 0 ? void 0 : _d.waitForRendering) ? this.view.scrollDOM.scrollTop : 0 }];
            this.releaseVelocity = 0;
        ...
        this.onTouchMove = (event) => {
            ...
            if (Math.abs(delta) > .1) {
                ...
                if (!this.config.waitForRendering || justClaimed && target >= bounds.from && target <= bounds.to)
                    this.applyMovement();
                else
        ...
        this.onTouchEnd = (event) => {
            ...
            if (this.touchScrolled && event.cancelable)
                event.preventDefault();
            this.touchScrolled = false;
            if (!this.tracking)
                return;
            ...
            if ((_c = this.config) === null || _c === void 0 ? void 0 : _c.waitForRendering)
                this.scheduleMovement();
            else
                this.finishGesture();
        };
        ...
        */
            ...
            if (Math.abs(delta) > .1) {
                ...
                if (Math.abs(target - previous) > .1) {
                    ...
                    if (Math.abs(committed - previous) > .1) {
                        ...
                        if ((_a = this.config) === null || _a === void 0 ? void 0 : _a.waitForRendering)
        ...
        this.startIdlePrewarm = () => {
            ...
            if (height <= 0) {
                this.scheduleIdlePrewarm((_c = (_b = this.config) === null || _b === void 0 ? void 0 : _b.settleDelay) !== null && _c !== void 0 ? _c : 0);
                return;
            }
    ...
    */
    ...
    beforeUpdate(transactions) {
        ...
        if (transactions.some(tr => tr.docChanged || tr.reconfigured || tr.selection ||
            tr.scrollIntoView || tr.effects.some(effect => effect.is(scrollIntoView))))
            this.cancel();
    }
    update(update) {
    ...
    debugSnapshot() {
        var _a, _b;
        return {
            waitForRendering: (_b = (_a = this.config) === null || _a === void 0 ? void 0 : _a.waitForRendering) !== null && _b !== void 0 ? _b : true,
    ...
    */
    ...
    bindResize() {
        ...
        (_a = this.resizeWindow.visualViewport) === null || _a === void 0 ? void 0 : _a.addEventListener("resize", this.onResize);
    ...
    unbindResize() {
        ...
        (_c = (_b = this.resizeWindow) === null || _b === void 0 ? void 0 : _b.visualViewport) === null || _c === void 0 ? void 0 : _c.removeEventListener("resize", this.onResize);
        (_d = this.resizeWindow) === null || _d === void 0 ? void 0 : _d.removeEventListener("blur", this.onTouchCancel);
        this.resizeWindow = null;
    }
    activateCorridor() {
        var _a;
    ...
    scheduleIdlePrewarm(delay) {
        var _a;
        if (!this.enabled || this.destroyed || !((_a = this.config) === null || _a === void 0 ? void 0 : _a.waitForRendering))
            return;
        this.clearPrewarmTimer();
    ...
    maybeExtendCorridor() {
        var _a;
        if (!((_a = this.config) === null || _a === void 0 ? void 0 : _a.waitForRendering) || this.preparing || hasPendingInput())
            return;
        let scroller = this.view.scrollDOM, height = scroller.clientHeight;
